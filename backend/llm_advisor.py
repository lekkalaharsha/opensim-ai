...
from backend.groq_advisor import GroqBackendAdvisor  # re-exported for backward compat
...
# GroqBackendAdvisor is defined in backend/groq_advisor.py and re-imported above.
